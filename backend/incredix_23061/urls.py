"""incredix_23061 URL Configuration
...
admin.site.site_header = "Incredix"
admin.site.site_title = "Incredix Admin Portal"
admin.site.index_title = "Incredix Admin"

# swagger
api_info = openapi.Info(
    title="Incredix API",
    default_version="v1",
    description="API documentation for Incredix App",
)
